        ...
        <div className="flex bg-slate-100 p-1 rounded-lg">
          <button
            ...
            className={`px-4 py-2 text-sm font-semibold rounded-md transition-all ${
              viewMode === 'input' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
            Set Availability
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm font-semibold rounded-md transition-all ${
              viewMode === 'view' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
            View My Shifts
          </button>
